...
(typecheck-fail (Producer -1)
 #:with-msg "Producer: failed side-condition: \\(>= -1 0\\).*\\(Producer -1\\)")
(typecheck-fail (Producer (- 1 2))
 #:with-msg "Producer: failed side-condition: \\(>= \\(- 1 2\\) 0\\).*\\(Producer \\(- 1 2\\)\\)")
